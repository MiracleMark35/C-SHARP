        ...
        case "3":
           ...
           //  validEntry = false;
            ...
            {   
                ...
                {
                    Console.WriteLine("INvalid ID/ Not Found");
                }
            }
            }while (validEntry == false);
            validEntry = false;
            do
            {
            Console.WriteLine("Enter a physical description for ID #: ");
            readResult = Console.ReadLine();
            ...
            {   
                if(readResult != null)
                {
                    if (ourAnimals[i, 0] == $"ID #: {readResult}")
                {
                  Console.WriteLine("(size, color, breed, gender, weight, housebroken)");
                 readResult = Console.ReadLine();           
                 if(readResult != null)
                 {
                 animalPhysicalDescription = readResult.ToLower();
